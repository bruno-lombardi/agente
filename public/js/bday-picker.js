...
(function( $ ){
    ...
    $.fn.birthdaypicker = function( options ) {
      ...
      return this.each(function() {
        ...
        var $fieldset = $("<div class='form-row bday-picker'><div class='col-12'><label>Data de nascimento</label></div></div>"),
            ...
            wrapper = "<div class='col-md-4 form-group'></div>";
        ...
        if (settings["dateFormat"] == "bigEndian") {
          ...
          $fieldset.append($(wrapper).append($day)).append($(wrapper).append($month)).append($(wrapper).append($year));
          if (tabindex != null) {
            $day.attr('tabindex', tabindex);
            $month.attr('tabindex', tabindex++);
            $year.attr('tabindex', tabindex++);
        ...
        if (settings["placeholder"]) {
          $("<option value='0'>Ano</option>").appendTo($year);
          $("<option value='0'>Mês</option>").appendTo($month);
